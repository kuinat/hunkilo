...
class LaravelApiClient extends GetxService with ApiClient {
  ...
  Future getAllParentCategories() async {
    var headers = {
      'api-key': "NMMAG3K4IVS0L6VYEPXLJ1Z0RR77AR67",
      'Cookie': 'session_id=b7ead5a5a19ffd6a8c3d9e4d10f4a435edde2e9e'
    };
    var request = http.Request('GET',
        Uri.parse("https://willonhair.shintheo.com/api/business.resource.type/search?"));
